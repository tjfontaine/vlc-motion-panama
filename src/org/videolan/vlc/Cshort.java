...
public class Cshort {
    ...
    public static MemoryAddress allocate(short value, NativeAllocationScope scope) {
    ...
    public static MemoryAddress allocateArray(short[] arr, NativeAllocationScope scope) {
        var arrLayout = MemoryLayout.ofSequence(arr.length, LAYOUT);
