...
public class Cfloat {
    ...
    public static MemoryAddress allocate(float value, NativeAllocationScope scope) {
    ...
    public static MemoryAddress allocateArray(float[] arr, NativeAllocationScope scope) {
        var arrLayout = MemoryLayout.ofSequence(arr.length, LAYOUT);
